                ...
                <div className="col-md-6 offset-md-3">
                    ...
                    <form onSubmit={this.submitHandler}>
                        <div className="form-group">
                            ...
                            />
                            {error.name && <div className="inavlid-feedback">
                                {error.name}
                            </div>}
                        </div>
                        <div className="form-group">
                            ...
                            <input 
                                ...
                                onChange={this.changeHandler}
                            />
                            {error.email && <div className="inavlid-feedback">
                                {error.email}
                            </div>}
                        </div>
                        <div className="form-group">
                            ...
                            <input 
                                ...
                                onChange={this.changeHandler}
                            />
                            {error.password &&<div className="inavlid-feedback">
                                {error.password}
                            </div>}
                        </div>
                        <div className="form-group">
                            ...
                            <input 
                                ...
                                onChange={this.changeHandler}
                            />
                            {error.confirmPassword &&<div className="inavlid-feedback">
